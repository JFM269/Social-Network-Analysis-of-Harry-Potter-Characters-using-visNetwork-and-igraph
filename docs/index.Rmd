...
edges_transformed <- edges |>
  # Join with nodes to get ids for source using the 'characters' column from nodes
  left_join(nodes_transformed, by = c("source" = "label")) |>
  rename(from = id) |>
  # Join with nodes to get ids for target using the 'characters' column from nodes
...
network_degree <- visNetwork(nodes_transformed, edges_transformed, height = '350px', width = "100%", main = "Degree Centrality") |>
  visLayout(randomSeed = 123) |>
...
network_weighted_degree <- visNetwork(nodes_transformed, edges_transformed, height = '350px', width = "100%", main = "Weighted Degree Centrality") |>
  visLayout(randomSeed = 123) |>
  visNodes(color = list(border = "black",background = nodes_transformed$color.background),size = 20) |>
...
network <- visNetwork(nodes_transformed, edges_transformed, width = "100%", main = "Harry Potter Characters Network by Community")|>
  visLayout(randomSeed = 123)|>
  visNodes(color = list(border = "black",background = nodes_transformed$color.community),size = 20) |>
  visEdges(width = 1)|>
